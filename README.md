# BAN 6003 Weeks 5-6: Basic, String, and Categorical Transformation with Pandas

**BAN 6003: Data Management and Analytics Integration**  
**Weeks 5-6 GitHub Classroom Template**
...
```bash
git add .
git commit -m "Complete Weeks 5-6 BAN 6003 assignment"
git push
```
